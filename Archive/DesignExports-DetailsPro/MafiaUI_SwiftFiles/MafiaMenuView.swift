            ...
            VStack {
                ...
                NavigationLink(destination: SetGameView()) {
                    RoundedRectangle(cornerRadius: 30, style: .continuous).fill(Color.green.opacity(1))
                        .overlay(RoundedRectangle(cornerRadius: 30, style: .continuous).stroke(Color.detailsSystemBackground, lineWidth: 2))
                        .frame(width: 140, height: 70)
                        .overlay {
                            Group {
                                Text("Play")
                                    .foregroundColor(Color.detailsSystemBackground)
                                    .font(.title2)
                            }
                        }
